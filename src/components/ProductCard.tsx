...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 shadow-lg border-2 border-pink-100 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:scale-[1.02] hover:border-pink-200 relative overflow-hidden">
      ...
      <div className="flex items-start space-x-3">
        <div className="relative">
          <img
            src={product.image}
            alt={product.name}
            className="w-16 h-16 rounded-xl object-cover border-2 border-pink-100 shadow-md"
            onError={(e) => {
              e.currentTarget.src = "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=200";
            }}
          />
          {/* Cute corner decoration */}
          <div className="absolute -top-1 -right-1 w-3 h-3 bg-pink-300 rounded-full flex items-center justify-center">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-2">
            <h3 className="font-medium text-gray-800 flex items-center text-sm truncate">
              {product.name}
          ...
          <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border-2 mb-2 ${
          ...
          <div className="text-xs text-gray-500 bg-gray-50 rounded-lg px-2 py-2">
